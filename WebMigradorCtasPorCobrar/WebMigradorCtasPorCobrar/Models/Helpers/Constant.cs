...
namespace WebMigradorCtasPorCobrar.Models.Helpers
{
    ...
    {
        public static readonly string PREGRADO_TEMPORAL_CUOTA_PAGO = "PRE_CP_DES"; //1
        ...
        public static readonly string POSGRADO_TEMPORAL_CUOTA_PAGO = "EUPG_CP_DES"; //2
        ...
        public static readonly string EUDED_TEMPORAL_CUOTA_PAGO = "EUDED_CP_DES"; //3
