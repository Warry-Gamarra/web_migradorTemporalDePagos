...
namespace WebMigradorCtasPorCobrar.Models.Services.Migracion.Obligaciones
{
    public class ObligacionService
    {
        ...
        public IEnumerable<Response> MigrarDatosTemporalPagos(Procedencia procedencia, string anio)
        {
            ...
            ObligacionRepository obligacionRepository = new ObligacionRepository();
            PagoObligacionRepository pagoPbligacionRepository = new PagoObligacionRepository();

            if (!string.IsNullOrEmpty(anio))
            {
                responseObl = obligacionRepository.MigrarDataObligacionesCtasPorCobrar(procedencia_id, anio);
            ...
            for (int anio = 2005; anio < 2023; anio++)
            {
                ...
                responsePago = pagoPbligacionRepository.MigrarDataPagoObligacionesCtasPorCobrar((int)procedencia);
