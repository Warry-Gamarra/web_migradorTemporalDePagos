        ...
        public Response CopiarRegistrosTasas(int procedenciaID, string codigos_bnc)
        {
            ...
            try
            {
                using (var connection = new SqlConnection(Databases.MigracionTPConnectionString))
                {
                    ...
                    connection.Execute("USP_Tasas_ConceptoPago_MigracionTP_IU_CopiarTablaTemporalPagos", parameters, commandType: CommandType.StoredProcedure);
        ...
        public Response InicializarEstadoValidacionCuotaPago(int? rowID, int procedenciaID)
        {
            ...
            try
            {
                using (var connection = new SqlConnection(Databases.MigracionTPConnectionString))
                {
                    ...
                    connection.Execute("USP_Tasas_CuotaPago_MigracionTP_U_InicializarEstadosValidacion", parameters, commandType: CommandType.StoredProcedure);
