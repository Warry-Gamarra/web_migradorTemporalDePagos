...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        previous: $('<a>' + options.labelPrevious + '</a>').attr("href", "#").addClass("btn btn-primary float-left"),
        next: $('<a>' + options.labelNext + '</a>').attr("href", "#").addClass("btn btn-success"),
        finish: $('<a>' + options.labelFinish + '</a>').attr("href", "#").addClass("btn btn-secondary float-right")
    };
