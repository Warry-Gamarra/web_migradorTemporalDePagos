...
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_TYPE = 'PROCEDURE' AND ROUTINE_NAME = 'USP_Tasas_ConceptoPago_MigracionTP_IU_CopiarTablaTemporalPagos')
BEGIN
	DROP PROCEDURE dbo.USP_Tasas_ConceptoPago_MigracionTP_IU_CopiarTablaTemporalPagos
END
GO

CREATE PROCEDURE dbo.USP_Tasas_ConceptoPago_MigracionTP_IU_CopiarTablaTemporalPagos
(
...
--exec USP_Tasas_ConceptoPago_MigracionTP_IU_CopiarTablaTemporalPagos @I_ProcedenciaID, @T_Codigo_bnc, @B_Resultado output, @T_Message output
...
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_TYPE = 'PROCEDURE' AND ROUTINE_NAME = 'USP_Tasas_ConceptoPago_MigracionTP_U_InicializarEstadosValidacion')
	DROP PROCEDURE [dbo].[USP_Tasas_ConceptoPago_MigracionTP_U_InicializarEstadosValidacion]
GO

CREATE PROCEDURE dbo.USP_Tasas_ConceptoPago_MigracionTP_U_InicializarEstadosValidacion	
	@I_RowID	  int = NULL,
	@I_ProcedenciaID tinyint,
	@B_Resultado  bit output,
	@T_Message	  nvarchar(4000) OUTPUT	
...
--		@T_Message	  nvarchar(4000)
--exec USP_Tasas_ConceptoPago_MigracionTP_U_InicializarEstadosValidacion @I_RowID, @I_ProcedenciaID, @B_Resultado output, @T_Message output
--select @B_Resultado as resultado, @T_Message as mensaje
BEGIN
	BEGIN TRANSACTION
	BEGIN TRY 
...
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_TYPE = 'PROCEDURE' AND ROUTINE_NAME = 'USP_Tasas_ConceptoPago_MigracionTP_U_ValidarTipoObligacion')
	DROP PROCEDURE [dbo].[USP_Tasas_ConceptoPago_MigracionTP_U_ValidarTipoObligacion]
GO

CREATE PROCEDURE dbo.USP_Tasas_ConceptoPago_MigracionTP_U_ValidarTipoObligacion
(
	@I_RowID	  int = NULL,
	@I_ProcedenciaID tinyint,
	@B_Resultado  bit output,
...
--		@I_ProcedenciaID tinyint = 4,
--		@T_Message	  nvarchar(4000)
--exec USP_Tasas_ConceptoPago_MigracionTP_U_ValidarTipoObligacion @I_RowID, @I_ProcedenciaID, @B_Resultado output, @T_Message output
--select @B_Resultado as resultado, @T_Message as mensaje
...
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_TYPE = 'PROCEDURE' AND ROUTINE_NAME = 'USP_Tasas_ConceptoPago_MigracionTP_IU_MigrarDataTemporalPagos')
BEGIN
	DROP PROCEDURE dbo.USP_Tasas_ConceptoPago_MigracionTP_IU_MigrarDataTemporalPagos
END
GO

CREATE PROCEDURE dbo.USP_Tasas_ConceptoPago_MigracionTP_IU_MigrarDataTemporalPagos
(
	@I_RowID	  int = NULL,
	@I_ProcedenciaID tinyint,
	@B_Resultado  bit output,
...
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_TYPE = 'PROCEDURE' AND ROUTINE_NAME = 'USP_Tasas_ConceptoPago_MigracionTP_IU_MigrarDataTemporalPagosPorRowID')
BEGIN
	DROP PROCEDURE dbo.USP_Tasas_ConceptoPago_MigracionTP_IU_MigrarDataTemporalPagosPorRowID
END
GO

CREATE PROCEDURE dbo.USP_Tasas_ConceptoPago_MigracionTP_IU_MigrarDataTemporalPagosPorRowID
(
	@I_RowID	  int = NULL,
	@I_ProcedenciaID tinyint,
	@B_Resultado  bit output,
