...
--select * from ##TEMP_DEL_ConstanciaPago
--select * from ##TEMP_DEL_PagoBanco
--select * from ##TEMP_DEL_PagoProcesadoUnfv
--select * from ##TEMP_DEL_ObligacionAluDet
--select * from ##TEMP_DEL_ObligacionAluCab


--drop table ##TEMP_DEL_ConstanciaPago
--drop table ##TEMP_DEL_PagoBanco
--drop table ##TEMP_DEL_PagoProcesadoUnfv
--drop table ##TEMP_DEL_ObligacionAluDet
--drop table ##TEMP_DEL_ObligacionAluCab


--SELECT * FROM ##TEMP_DEL_PagoBanco WHERE I_PagoBancoID = 219801
--SELECT * FROM BD_OCEF_MigracionTP..TR_Ec_Det WHERE I_RowID = 577697


--select * from  BD_OCEF_MigracionTP..TR_Ec_Det where Cod_alu = '2017026898' and Nro_recibo = '0004292947' and Concepto = 0

SELECT * FROM TR_ObligacionAluCab WHERE I_ProcesoID BETWEEN 1 AND 498
SELECT * FROM TC_Proceso