...
INSERT INTO ##TEMP_DEL_PagoBanco (I_PagoBancoID, I_EntidadFinanID, C_CodOperacion, C_CodDepositante, T_NomDepositante, C_Referencia, D_FecPago, I_Cantidad, C_Moneda, I_MontoPago, T_LugarPago, B_Anulado, I_UsuarioCre, D_FecCre, T_Observacion, T_InformacionAdicional, I_CondicionPagoID, I_TipoPagoID, I_CtaDepositoID, I_InteresMora, T_MotivoCoreccion, I_UsuarioMod, D_FecMod, C_CodigoInterno, I_ProcesoIDArchivo, T_ProcesoDescArchivo, D_FecVenctoArchivo, B_Migrado, I_MigracionTablaID, I_MigracionRowID)
						  SELECT PB.I_PagoBancoID, I_EntidadFinanID, C_CodOperacion, C_CodDepositante, T_NomDepositante, C_Referencia, D_FecPago, I_Cantidad, C_Moneda, I_MontoPago, T_LugarPago, B_Anulado, PB.I_UsuarioCre, PB.D_FecCre, T_Observacion, T_InformacionAdicional, I_CondicionPagoID, I_TipoPagoID, I_CtaDepositoID, I_InteresMora, T_MotivoCoreccion, I_UsuarioMod, D_FecMod, C_CodigoInterno, I_ProcesoIDArchivo, T_ProcesoDescArchivo, D_FecVenctoArchivo, B_Migrado, I_MigracionTablaID, I_MigracionRowID
							FROM TR_PagoBanco PB
								 INNER JOIN ##TEMP_DEL_ConstanciaPago TMP ON PB.I_PagoBancoID = TMP.I_PagoBancoID

INSERT INTO ##TEMP_DEL_PagoProcesadoUnfv (I_PagoProcesID, I_PagoBancoID, I_CtaDepositoID, I_TasaUnfvID, I_MontoPagado, I_SaldoAPagar, I_PagoDemas, B_PagoDemas, N_NroSIAF, B_Anulado, D_FecCre, I_UsuarioCre, D_FecMod, I_UsuarioMod, I_ObligacionAluDetID, B_Migrado, I_MigracionTablaID, I_MigracionRowID)
						  SELECT I_PagoProcesID, PP.I_PagoBancoID, PP.I_CtaDepositoID, I_TasaUnfvID, I_MontoPagado, I_SaldoAPagar, I_PagoDemas, B_PagoDemas, N_NroSIAF, B_Anulado, D_FecCre, I_UsuarioCre, D_FecMod, I_UsuarioMod, I_ObligacionAluDetID, B_Migrado, I_MigracionTablaID, I_MigracionRowID
